...
{
    /// <summary>
    /// ConnectionString = "Data Source=D:/Documents/Prueba.db;Version=3;"
    /// </summary>
    public class SQLite : Plugin, IPlugin
    {
        private const string PREFIX = "@";
        
        private static readonly Type JSObjectType = typeof(JavaScript.Object);
        ...
        private SQLiteCommand GetCommand(string query, object? parameters)
        {
            ...
            if(parameters != null)
                if(JSObjectType.IsAssignableFrom(parameters.GetType()))
                    SetParameters(command, (JavaScript.Object)parameters);
        ...
        private static void SetParameters(SQLiteCommand command, JavaScript.Object parameters)
        {
