namespace WV.Win.Win32.Enums
{
    ...
    /// </summary>
    internal enum GetWinLong : int
    {
        /// <summary>Sets a new address for the window procedure.</summary>
        /// <remarks>You cannot change this attribute if the window does not belong to 
        /// the same process as the calling thread.</remarks>
        GWL_WNDPROC = -4,
        ...
        /// <remarks>This data is intended for use by the application that created the window. 
        /// Its value is initially zero.</remarks>
        GWL_USERDATA = -21,
        ...
        /// <summary>Sets new extra information that is private to the application, 
        /// such as handles or pointers.</summary>
        /// <remarks>Only applies to dialog boxes.</remarks>
        DWLP_USER = 8,
