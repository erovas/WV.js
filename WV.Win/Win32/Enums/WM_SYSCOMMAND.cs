...
{
    // https://learn.microsoft.com/es-es/windows/win32/menurc/wm-syscommand
    /// <summary>
    /// IntPtr WndProc(IntPtr hWnd, WinMsg msg, WM_SysCmd wParam, IntPtr lParam)
    /// </summary>
    internal enum WM_SYSCOMMAND : int
    {
        /// <summary>
        /// Closes the window.
        /// </summary>
        ...
        /// <summary>
        /// Sets the state of the display. This command supports devices that have power-saving features, 
